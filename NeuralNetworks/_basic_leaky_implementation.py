...
test_fn = os.path.join(file_path, "test_set_2021_forward_v2023-11-08.csv")
with open(test_fn) as f:
    test = pd.read_csv(f, sep=',')

trans_fn = os.path.join(file_path, "mean_std_training_v2023-11-10.csv")
...
selected_cols = ['feature', 'date', 'value', 'p_act_1', 'p_act_2', 'p_act_3', 'p_act_4', 'p_act_5', 'p_act_6', 'p_act_1_ts', 'p_act_2_ts', 'p_act_3_ts', 'p_act_4_ts']
test_selected = test[selected_cols]

test_selected["LOO_ensemble_pred"] = np.mean(test_selected[['p_act_1', 'p_act_2', 'p_act_3', 'p_act_4', 'p_act_5', 'p_act_6']], axis=1)
test_selected["ts_ensemble_pred"] = np.mean(test_selected[['p_act_1_ts', 'p_act_2_ts', 'p_act_3_ts', 'p_act_4_ts']], axis=1)

ensemble_cols = ['feature', 'date', 'value', 'LOO_ensemble_pred', 'ts_ensemble_pred']
