...
write_csv(test, file.path(nn_dir, paste0('test_set_2021_forward_v', Sys.Date(), '.csv')))
```
...
write_csv(training, file.path(nn_dir, paste0('training_set_up_to_2021_v', Sys.Date(), '.csv')))
```
