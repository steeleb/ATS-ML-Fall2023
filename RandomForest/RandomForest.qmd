...
baseline_by_lake <- full_dataset %>% 
  group_by(feature, day_of_year) %>% 
  summarize(mean_temp_by_lake_deg_C = mean(value)) %>% 
...
number_of_trees = 40
tree_depth = 7
node_split = 5   # minimum number of training samples needed to split a node
...
train_val1$pred = pred

ggplot(train_val1, aes(x = date, y = value)) +
  facet_grid(feature ~ .) +
  geom_point() +
...
train_val3$pred = pred

ggplot(train_val3, aes(x = date, y = value)) +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_point(aes(y = pred), color = 'orange') +
  theme_bw()
...
train_val4$pred = pred

ggplot(train_val4, aes(x = date, y = value)) +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_point(aes(y = pred), color = 'orange') +
  theme_bw()
...
train_val5$pred = pred

ggplot(train_val5, aes(x = date, y = value)) +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_point(aes(y = pred), color = 'orange') +
  theme_bw()
...
train_val6$pred = pred

ggplot(train_val6, aes(x = date, y = value)) +
  facet_grid(feature ~ .) +
  geom_point() +
  geom_point(aes(y = pred), color = 'orange') +
  theme_bw()
